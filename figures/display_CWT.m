function [] = display_CWT(sst,rslt,n,pad, name)
    ...
    set(gca,'Xtick', 20:20:160)
    
    %keyboard()
    %set(gca,'Xtick', round([1:288*22:n]*(fig.t(2)-fig.t(1))))
    %set(gca,'Xtick', 1:288*22:n)
    %set(gca,'Xticklabel',datestr(ret1(1:288*22:n,1), 'mm-dd'))
